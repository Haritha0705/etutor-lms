...
const Courses: React.FC<CoursesP> = ({ allData: propAllData }) => {
    ...
    const dataToUse = propAllData || allData;
            ...
            <div className="flex justify-center items-center mt-10 space-x-2">
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <button
                        ...
                        className={`px-3 py-2 rounded-full ${currentPage === page ? "bg-orange-500 hover:bg-orange-600 text-white" : "bg-white hover:bg-orange-300/30 hover:text-orange-500"
                        }`}
                    >
